...
[key pair 생성하기]({% post_url 2020-04-17-how-to-create-key-pair %})
...
2. 원하는 이미지 소스를 선택합니다.   
  ...
  저는 Ubuntu 20.04 Minimal 을 선택 했습니다.)
...
5. 생성 버튼을 클릭합니다.
  VM이 할당되면 공인 IP를 통해 접속할 수 있습니다.
![스크린샷3](/assets/screenshots/2020-04-16/screenshot4.png)  

OCI 센터의 FreeTier 가용량에 따라 아래와 같이 VM 생성이 실패할 수 있습니다.
![스크린샷3](/assets/screenshots/2020-04-16/screenshot3.png)  
이런 경우에는 기다렸다가 나중에 다시 생성해야 합니다.
{: .notice--danger}
